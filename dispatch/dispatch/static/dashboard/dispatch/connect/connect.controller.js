...
var QDR = (function (QDR) {
  ...
  /**
   * @method ConnectController
   *
   * Controller that handles the connect page
   */
  angular
    .module('horizon.dashboard.dispatch.connect')
    .controller('horizon.dashboard.dispatch.connect.ConnectController', ConnectController);
  ...
  ConnectController.$inject = [
    ...
    '$location',
    '$timeout',
    'horizon.dashboard.dispatch.connect.basePath'
  ];
  ...
  function ConnectController(
    ...
    QDR.log.debug("QDR.ConnectControll started with location of " + $location.path() + " and connection of  " + QDRService.connected + " and basePath of " + basePath);
